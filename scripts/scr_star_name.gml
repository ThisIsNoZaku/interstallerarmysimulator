...
repeat(100){
    ...
    if (ok=0){
        ...
        if (rand=47) and (rand2<=10) then num="Kim Jong";
        if (rand=47) and (rand2>10) then num="Gonj Mik";
        ...
        if (rand=53) and (rand2<=10) then num="Betelgeuse";
        if (rand=53) and (rand2>10) then num="Betechton";
        ...
        if (rand=60) and (rand2<=10) then num="Bongistan";
        if (rand=60) and (rand2>10) then num="Natsigan";
        if (rand=61) then num="Orwell";
        if (rand=62) and (rand2<=10) then num="Dagobah";
        if (rand=62) and (rand2>10) then num="Haboga";
