...
if (argument1="+"){
    ...
    repeat(30){
        ...
        if (obj_controller.loyal[i]=argument0){// Increases detection chance by a variable amount
            ...
            if (argument0="Mutant "+string(obj_img.organics)){
            ...
            if (argument0="Crossing the "+string(obj_img.faction[4])){
        ...
        if (obj_controller.loyal_num[i]<1) and (obj_controller.loyal_num[i]>0) and (obj_controller.loyal[i]!="Avoiding Inspections"){
            ...
            if (diceh<=(obj_controller.loyal_num[i]*1000)){
                if (obj_controller.loyal[i]="Heretic Contact"){
                    ...
                    scr_alert("red","inspect",string(obj_img.faction_dude_formal[4])+" discovers evidence of "+string(obj_img.faction_title[11])+" correspondence.",0,0);
                ...
                if (obj_controller.loyal[i]="Mutant "+string(obj_img.organics)){obj_controller.loyal_num[i]=30;obj_controller.loyal_time[i]=9999;}
                ...
                if (obj_controller.loyal[i]=string(obj_img.faction[6])+" Contact"){obj_controller.loyal_num[i]=4;obj_controller.loyal_time[i]=9999;}
                if (obj_controller.loyal[i]=string(obj_img.faction[7])+" Contact"){obj_controller.loyal_num[i]=4;obj_controller.loyal_time[i]=9999;}
                if (obj_controller.loyal[i]=string(obj_img.faction[8])+" Contact"){obj_controller.loyal_num[i]=4;obj_controller.loyal_time[i]=9999;}
                ...
                if (obj_controller.loyal[i]=string(obj_img.faction_dude_formal[4])+" Killer"){obj_controller.loyal_num[i]=100;obj_controller.loyal_time[i]=9999;}
