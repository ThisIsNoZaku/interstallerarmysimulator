...
if (specialist>=0){
    ...
    if (argument2=string(obj_img.blade)+"sword") then allow=true;
    if (argument2=string(obj_img.blade)+"axe") then allow=true;
    if (argument2="Boarding Shield") then allow=true;
    if (argument2=string(obj_img.gyro_adj)+" Pistol") then allow=true;
    if (argument2=string(obj_img.gyro)) then allow=true;
...
if (specialist>=1){
    if (argument2="Storm "+string(obj_img.gyro)) then allow=true;
