...
if (instance_exists(argument1)) and (owner=1){
    ...
    if (argument0>0) or (argument0<-40){// Normal shooting
        ...
        if (that_works=true){
            ...
            if (argument0>0){
                if (wep_num[argument0]<=0) then exit;
            ...
            if (argument0<-40){
                ...
                if (argument0=-51){wii="Heavy "+string(obj_img.gyro)+" Emplacement";at=160;ap=0;}
...
if (instance_exists(argument1)) and (owner=1){
    ...
    if (argument0<-40){// Defenses shooting
        ...
        spla=1;
        if (argument0=-51){wii="Heavy "+string(obj_img.gyro)+" Emplacement";at=160;ar=0;}
        if (argument0=-52){wii="Missile Launcher Emplacement";at=200;ar=1;}
        if (argument0=-53){wii="Missile Silo";at=250;ar=0;}
