...
i=0;repeat(10){i+=1;
    if (role[co,i]=obj_img.faction_title[1]){v+=1;
...
i=0;repeat(300){i+=1;
    if (role[co,i]="Death Company"){
        if (armor[co,i]="Tartaros") or (string_count(obj_img.battlesuit,armor[co,i])>0){v+=1;
            temp_race[co,v]=race[co,i];temp_loc[co,v]=loc[co,i];temp_name[co,v]=name[co,i];temp_role[co,v]=role[co,i];temp_lid[co,v]=lid[co,i];
            temp_wid[co,v]=wid[co,i];temp_wep1[co,v]=wep1[co,i];temp_wep2[co,v]=wep2[co,i];temp_armor[co,v]=armor[co,i];temp_gear[co,v]=gear[co,i];
            temp_hp[co,v]=hp[co,i];temp_chaos[co,v]=chaos[co,i];temp_experience[co,v]=experience[co,i];temp_age[co,v]=age[co,i];
            temp_mobi[co,v]=mobi[co,i];temp_spe[co,v]=spe[co,i];temp_god[co,v]=god[co,i];temp_bio[co,v]=bio[co,i];
...
i=0;repeat(300){i+=1;
    if (role[co,i]="Death Company"){
        if (string_count(obj_img.unit[1,6],armor[co,i])>0){v+=1;
            temp_race[co,v]=race[co,i];temp_loc[co,v]=loc[co,i];temp_name[co,v]=name[co,i];temp_role[co,v]=role[co,i];temp_lid[co,v]=lid[co,i];
            temp_wid[co,v]=wid[co,i];temp_wep1[co,v]=wep1[co,i];temp_wep2[co,v]=wep2[co,i];temp_armor[co,v]=armor[co,i];temp_gear[co,v]=gear[co,i];
            temp_hp[co,v]=hp[co,i];temp_chaos[co,v]=chaos[co,i];temp_experience[co,v]=experience[co,i];temp_age[co,v]=age[co,i];
            temp_mobi[co,v]=mobi[co,i];temp_spe[co,v]=spe[co,i];temp_god[co,v]=god[co,i];temp_bio[co,v]=bio[co,i];
...
i=0;repeat(300){i+=1;
    if (role[co,i]="Death Company"){
        if (string_count(obj_img.unit[1,6],armor[co,i])=0) and (string_count(obj_img.battlesuit,armor[co,i])=0) and (armor[co,i]!="Tartaros"){v+=1;
            temp_race[co,v]=race[co,i];temp_loc[co,v]=loc[co,i];temp_name[co,v]=name[co,i];temp_role[co,v]=role[co,i];temp_lid[co,v]=lid[co,i];
            temp_wid[co,v]=wid[co,i];temp_wep1[co,v]=wep1[co,i];temp_wep2[co,v]=wep2[co,i];temp_armor[co,v]=armor[co,i];temp_gear[co,v]=gear[co,i];
            temp_hp[co,v]=hp[co,i];temp_chaos[co,v]=chaos[co,i];temp_experience[co,v]=experience[co,i];temp_age[co,v]=age[co,i];
            temp_mobi[co,v]=mobi[co,i];temp_spe[co,v]=spe[co,i];temp_god[co,v]=god[co,i];temp_bio[co,v]=bio[co,i];
...
if (race[co,i]!=1){
    ...
    i=0;repeat(300){i+=1;
        if (role[co,i]=obj_img.unit[5,7]){v+=1;
            temp_race[co,v]=race[co,i];temp_loc[co,v]=loc[co,i];temp_name[co,v]=name[co,i];temp_role[co,v]=role[co,i];temp_lid[co,v]=lid[co,i];
            temp_wid[co,v]=wid[co,i];temp_wep1[co,v]=wep1[co,i];temp_wep2[co,v]=wep2[co,i];temp_armor[co,v]=armor[co,i];temp_gear[co,v]=gear[co,i];
            temp_hp[co,v]=hp[co,i];temp_chaos[co,v]=chaos[co,i];temp_experience[co,v]=experience[co,i];temp_age[co,v]=age[co,i];
            temp_mobi[co,v]=mobi[co,i];temp_spe[co,v]=spe[co,i];temp_god[co,v]=god[co,i];temp_bio[co,v]=bio[co,i];
    ...
    i=0;repeat(300){i+=1;
        if (role[co,i]=obj_img.unit[5,17]){v+=1;
            temp_race[co,v]=race[co,i];temp_loc[co,v]=loc[co,i];temp_name[co,v]=name[co,i];temp_role[co,v]=role[co,i];temp_lid[co,v]=lid[co,i];
            temp_wid[co,v]=wid[co,i];temp_wep1[co,v]=wep1[co,i];temp_wep2[co,v]=wep2[co,i];temp_armor[co,v]=armor[co,i];temp_gear[co,v]=gear[co,i];
            temp_hp[co,v]=hp[co,i];temp_chaos[co,v]=chaos[co,i];temp_experience[co,v]=experience[co,i];temp_age[co,v]=age[co,i];
            temp_mobi[co,v]=mobi[co,i];temp_spe[co,v]=spe[co,i];temp_god[co,v]=god[co,i];temp_bio[co,v]=bio[co,i];
