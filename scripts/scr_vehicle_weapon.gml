...
var melee;melee=0;
if (weep="Close Combat Weapon") then melee=1;if (weep=string(obj_img.blade)+"axe")then melee=1;
if (weep="Combat Knife")then melee=1;if (weep="Force Weapon")then melee=1;
if (weep=string(obj_img.hammer))then melee=1;if (weep="Power Sword")then melee=1;
...
if (weep=string(obj_img.gyro_adj)+" Pistol") or (weep="Storm "+string(obj_img.gyro)) then bull.direction+=random_range(-8,8);
if (weep=string(obj_img.gyro)) or ((weep="Combiflamer") and (diy>=80)) then bull.direction+=random_range(-4,4);
if (weep="Heavy "+string(obj_img.gyro)) then bull.direction+=random_range(-6,6);
if (weep=string(obj_img.laser)+"cannon") then bull.direction+=random_range(-2,2);
...
if (weep=string(obj_img.blade)+"sword"){with(bull){instance_destroy();}target[argument1].hp-=dym;}
if (weep=string(obj_img.blade)+"axe"){with(bull){instance_destroy();}target[argument1].hp-=dym;}
...
if (weep=string(obj_img.hammer)){with(bull){instance_destroy();}target[argument1].hp-=dym;}
