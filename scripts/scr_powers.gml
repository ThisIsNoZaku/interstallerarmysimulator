...
if (marine_type[argument3]=obj_img.faction_title[1]){
...
if (marine_type[argument3]=obj_img.faction_title[1]) and (peril1>1) then peril1=round(peril1/2);
...
if (peril2<=peril1) and (heh=2){
    ...
    if (peril3>87) and (peril3<=95){marine_hp[argument3]=-150;marine_dead[argument3]=2;
        ...
        if (obj_ini.role[marine_co[argument3],marine_id[argument3]]=obj_img.faction_title[1]) then global.defeat=3;
