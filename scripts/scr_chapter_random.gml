...
discipline="default";battle_cry="For the "+string(obj_img.king_title);
...
if (argument0=1){
    ...
    if (found_secret=4){adv[1]=string(obj_img.gyro)+" Drilling";betchers=1;membrane=1;mutations_selected+=2;mutations+=2;mutat=2;}
