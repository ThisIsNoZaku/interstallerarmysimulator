...
// Assigns premade "+string(obj_img.player_army)+" settings
...
if (argument0="Dark Angels"){founding="N/A";
    ...
    tech_name="Techmarine";chaplain_name="Chaplain";role[100,2]="Honor Guard";dreadnought_name=obj_img.unit[1,6];captain_name="Captain";
    master_melee=3;master_ranged=999;forbidden_unit1="";forbidden_unit2="";forbidden_unit3="";
    home_type="Dead";recruiting_type="Feral";recruiting_name="Kimmeria";home_name="The Rock";lord_admiral_name=scr_marine_name();
...
if (argument0="Imperial Fists"){founding="N/A";
    ...
    advantage2=3;adv2=string(obj_img.gyro)+" Drilling";advantage3=0;adv3="";disadvantage1=0;dis1="";disadvantage2=0;dis2="";disadvantage3=0;dis3="";
...
if (argument0="Imperial Fists"){
    ...
    tech_name="Techmarine";chaplain_name="Chaplain";role[100,2]="Honor Guard";dreadnought_name=obj_img.unit[1,6];
...
if (argument0="Blood Angels"){founding="N/A";
    ...
    battle_cry="For the "+string(obj_img.king_title)+" and Sanguinius! Death! DEATH";monastery_name="Fortress of Baal";master_name="Dante";
    ...
    tech_name="Techmarine";chaplain_name="Chaplain";role[100,2]="Sanguinary Guard";dreadnought_name=obj_img.unit[1,6];captain_name="Captain";
...
if (argument0="Iron Hands"){founding="N/A";
    ...
    veteran_name="Veteran";devastator_name="Devastator";assault_name="Assault Marine";apothecary_name="Apothecary";librarian_name="Librarian";
    tech_name="Iron Father";chaplain_name="Iron Father";role[100,2]="Honor Guard";dreadnought_name=obj_img.unit[1,6];captain_name="Captain";
...
if (argument0="Ultramarines"){founding="N/A";
    ...
    home_type="Temperate";recruiting_type="Feral";recruiting_name="Parmenio";home_name="Macragge";lord_admiral_name="Lazlo Tiberius";
...
if (argument0="Salamanders"){founding="N/A";
    ...
    veteran_name="Veteran";devastator_name="Devastator";assault_name="Assault Marine";apothecary_name="Apothecary";librarian_name="Librarian";
    tech_name="Techmarine";chaplain_name="Chaplain";role[100,2]="Pyre Guard";dreadnought_name=obj_img.unit[1,6];captain_name="Captain";
