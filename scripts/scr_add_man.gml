...
if (good!=0){
    ...
    if (argument8=true){
        ...
        if (argument0=obj_img.unit[5,7]){
            obj_ini.wep1[argument1,good]=string(obj_img.gyro);obj_ini.wep2[argument1,good]="Sarissa";
        ...
        if (argument0=obj_img.unit[5,17]){
            obj_ini.wep1[argument1,good]=string(obj_img.gyro);obj_ini.wep2[argument1,good]="Sarissa";
    ...
    if (argument0=obj_img.unit[5,7]) or (argument0=obj_img.unit[5,17]) then obj_ini.name[argument1,good]=scr_imperial_name(2);
    ...
    if (argument0!="Skitarii") and (argument0!="Techpriest") and (argument0!="Ranger") and (argument0!="Crusader") and (argument0!=obj_img.unit[5,7]){
        if (argument0!=obj_img.unit[5,17]) and (argument0!="Ork Sniper") and (argument0!="Flash Git") then marines+=1;
    }
