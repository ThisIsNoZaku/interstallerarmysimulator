...
if (menu=1) and (managing>0){
    ...
    draw_text(xx+800,yy+74,string(global.chapter_name)+" "+string(fx));
    ...
    if (managing<=10){
        ...
        draw_rectangle(xx+800-(bar_wid/2),yy+108,xx+800+(bar_wid/2),yy+100+string_height("LOL"),1);
        obj_cursor.image_index=0;
        
        if (scr_hit(xx+800-(bar_wid/2),yy+108,xx+800+(bar_wid/2),yy+100+string_height("LOL"))=false) and (mouse_left=1) and (cooldown<=0) then text_bar=0;
        if (scr_hit(xx+800-(bar_wid/2),yy+108,xx+800+(bar_wid/2),yy+100+string_height("LOL"))=true){
        ...
        if (obj_ini.company_title[managing]!="") or (text_bar>0){draw_set_font(fnt_fancy);
            if (text_bar=0) or (text_bar>31) then draw_text(xx+800,yy+110,"''"+string(obj_ini.company_title[managing])+"'' ");
            if (text_bar>0) and (text_bar<=31) then draw_text(xx+800,yy+110,"''"+string(obj_ini.company_title[managing])+"|''");
        }
    }
    ...
    if (instance_exists(cn)){
        if (cn.temp[101]!="") and (cn.temp[100]="1"){
            ...
            if (show_arm=string(obj_img.battlesuit)){ui_back=false;terg=1;}
            if (show_arm="Tartaros"){ui_back=false;terg=2;}
            if (show_arm=obj_img.unit[1,6]){ui_back=false;terg=5;}
            if (terg>0) then ui_back=false;
            ...
            if( shader_is_compiled(sReplaceColor)){
                ...
                // Special specialist stuff here        this was commented off for some reason
                ui_specialist=0;
                ...
                if (show_arm=string(obj_img.battlesuit)){armor_sprite=spr_terminator2_colors;if (brothers>-5) then brothers=5;if (hood=-50) then hood=9;if (skull=1) then skull=2;}
                ...
                draw_set_color(c_gray);
                draw_text(xx+1208,yy+178,"Color swap shader#did not compile");
            }*/
        ...
        if (cn.temp[101]!=""){
            ...
            if (cn.temp[100]="5"){
                if (string_count(obj_img.unit[5,7],cn.temp[101])>0) then draw_sprite(spr_sororitas,0,xx+1208,yy+178);
                if (string_count(obj_img.unit[5,17],cn.temp[101])>0) then draw_sprite(spr_sororitas,1,xx+1208,yy+178);
            }
            if (cn.temp[100]="6"){
        ...
        */
        ...
        draw_text_transformed(xx+1290,yy+145,string(cn.temp[101]),1.5,1.5,0);
        
        draw_set_font(fnt_40k_14);
        draw_set_halign(fa_left);
        
        if (cn.temp[102]!="") then draw_text_ext(xx+1015,yy+215,string(cn.temp[102])+"#"+string(cn.temp[103]),-1,187);
        if (cn.temp[102]!="") then draw_text_ext(xx+1016,yy+216,string(cn.temp[102]),-1,187);
        
        if (cn.temp[104]!="") then draw_text_ext(xx+1015,yy+280,string(cn.temp[104])+"#"+string(cn.temp[105]),-1,187);
        if (cn.temp[104]!="") then draw_text_ext(xx+1016,yy+281,string(cn.temp[104]),-1,187);
        
        if (cn.temp[106]!="") then draw_text_ext(xx+1015,yy+345,string(cn.temp[106])+"#"+string(cn.temp[107]),-1,187);
        if (cn.temp[106]!="") then draw_text_ext(xx+1016,yy+346,string(cn.temp[106]),-1,187);
        
        if (cn.temp[108]!="") then draw_text_ext(xx+1387,yy+215,string(cn.temp[108])+"#"+string(cn.temp[109]),-1,187);
        if (cn.temp[108]!="") then draw_text_ext(xx+1388,yy+216,string(cn.temp[108]),-1,187);
        
        if (cn.temp[110]!="") then draw_text_ext(xx+1387,yy+345,string(cn.temp[110])+"#"+string(cn.temp[111]),-1,187);
        if (cn.temp[110]!="") then draw_text_ext(xx+1388,yy+346,string(cn.temp[110]),-1,187);
        
        if (cn.temp[112]!="") then draw_text(xx+1015,yy+420,"Health: "+string(cn.temp[112]));
        if (cn.temp[113]!="") then draw_text(xx+1190,yy+420,"Experience: "+string(cn.temp[113]));
        if (cn.temp[114]!="") then draw_text(xx+1365,yy+420,"Bionics: "+string(cn.temp[114]));
        
        draw_set_color(c_gray);if (ui_melee_penalty>0) then draw_set_color(c_red);
        if (cn.temp[116]!="") then draw_text(xx+1015,yy+442,"Melee Attack: "+string(cn.temp[116]));
        
        draw_set_color(c_gray);if (ui_ranged_penalty>0) then draw_set_color(c_red);
        if (cn.temp[117]!="") then draw_text(xx+1190,yy+442,"Ranged Attack: "+string(cn.temp[117]));
        
        draw_set_color(c_gray);
        if (cn.temp[118]!="") then draw_text(xx+1365,yy+442,"Damage Resistance: "+string(cn.temp[118]));
        
        draw_set_font(fnt_40k_14i);
        if (cn.temp[119]!="") then draw_text(xx+1020,yy+468,string(cn.temp[119]));
    ...
    repeat(min(man_max,man_see)){
        ...
        if (man[sel]="man"){
            ...
            if (ma_role[sel]=obj_img.unit[5,7]) then normal_hp="no";
            if (ma_role[sel]=obj_img.unit[5,17]) then normal_hp="no";
            ...
            if (normal_hp="no"){
                ...
                if (ma_role[sel]="Skitarii") or (ma_role[sel]=obj_img.unit[5,7]) or (ma_role[sel]=obj_img.unit[5,17]) then mixhp=40;
        ...
        var name_xr;name_xr=1;repeat(10){if ((string_width(temp1)*name_xr)>184-8) then name_xr-=0.05;}
        
        if (temp1!=string(obj_img.faction_title[1])+" "+string(obj_ini.master_name)){
            ...
            draw_text_transformed(xx+27+8,yy+66,string(temp1),name_xr,1,0);
            draw_text_transformed(xx+28+8,yy+67,string(temp1),name_xr,1,0);
            draw_set_color(c_gray);
        }
        if (temp1=string(obj_img.faction_title[1])+" "+string(obj_ini.master_name)){
            draw_text_transformed(xx+27+16+8,yy+66,string(temp1),name_xr,1,0);
            draw_text_transformed(xx+28+16+8,yy+67,string(temp1),name_xr,1,0);
            draw_sprite(spr_inspect_small,0,xx+27+8,yy+68);
        }
        draw_set_alpha(1);
        
        draw_set_color(c_gray);
        draw_text_transformed(xx+240+8,yy+66,string(temp3),1,1,0);// HP
        draw_text_transformed(xx+330+8,yy+66,string(temp4),1,1,0);// EXP
        if (temp2=string(obj_img.faction_short[3])+" Vessel") or (temp2="Terra IV") or (temp2="=Penitorium=") then draw_set_alpha(0.5);
        draw_text_transformed(xx+430+8,yy+66,string(temp2),1,1,0);// LOC
        draw_set_alpha(1);
        
        
        // ma_lid[i]=0;ma_wid[i]=0;
        
        if (ma_loc[sel]=string(obj_img.faction_short[3])+" Vessel") then draw_sprite(spr_loc_icon,2,xx+427+8,yy+66);
        if (man[sel]="man"){
            if (ma_loc[sel]!=string(obj_img.faction_short[3])+" Vessel"){var berd;berd=false;
        ...
        if (man[sel]!="man"){
            if (ma_loc[sel]!=string(obj_img.faction_short[3])+" Vessel"){
                if (ma_lid[sel]=0) and (ma_wid[sel]>0) then draw_sprite(spr_loc_icon,0,xx+427+8,yy+66);
    ...
    */
    ...
    draw_set_color(c_gray);
    draw_set_font(fnt_40k_14b);draw_text_transformed(xx+1010,yy+528,"Selection: "+string(man_size)+" space",1.5,1.5,0);
    draw_set_font(fnt_40k_14);draw_text_ext(xx+1010,yy+552,selecting_dudes,-1,560);
    
    draw_set_font(fnt_40k_14b);draw_text_transformed(xx+1010,yy+610,"Options:",1.5,1.5,0);
    draw_set_font(fnt_40k_14);
    
    yy+=8;
    
    if (sel_uni[1]!=""){
        draw_text(xx+1010,yy+636,"All Infantry");
        draw_rectangle(xx+1010,yy+634,xx+1010+string_width("All Infantry"),yy+634+string_height("All Infantry"),1);
        if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
            if (mouse_x>=xx+1010) and (mouse_y>=yy+634) and (mouse_x<xx+1010+string_width("All Infantry")) and (mouse_y<yy+634+string_height("All Infantry")){cooldown=8;sel_all="man";}
        }
        
        if (sel_uni[1]!=""){
            draw_text(xx+1016,yy+662,sel_uni[1]);draw_rectangle(xx+1015,yy+661,xx+1016+string_width(sel_uni[1]),yy+661+string_height(sel_uni[1]),1);
            if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
                if (mouse_x>=xx+1015) and (mouse_y>=yy+661) and (mouse_x<xx+1016+string_width(sel_uni[1])) and (mouse_y<yy+661+string_height(sel_uni[1])){cooldown=8;sel_all=sel_uni[1];}
            }
        }
        if (sel_uni[2]!=""){
            draw_text(xx+1016,yy+684,sel_uni[2]);draw_rectangle(xx+1015,yy+683,xx+1016+string_width(sel_uni[2]),yy+683+string_height(sel_uni[2]),1);
            if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
                if (mouse_x>=xx+1016) and (mouse_y>=yy+684) and (mouse_x<xx+1016+string_width(sel_uni[2])) and (mouse_y<yy+683+string_height(sel_uni[2])){cooldown=8;sel_all=sel_uni[2];}
            }
        }
        if (sel_uni[3]!=""){
            draw_text(xx+1016,yy+706,sel_uni[3]);draw_rectangle(xx+1015,yy+705,xx+1016+string_width(sel_uni[3]),yy+705+string_height(sel_uni[3]),1);
            if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
                if (mouse_x>=xx+1016) and (mouse_y>=yy+706) and (mouse_x<xx+1016+string_width(sel_uni[3])) and (mouse_y<yy+705+string_height(sel_uni[3])){cooldown=8;sel_all=sel_uni[3];}
            }
        }
        if (sel_uni[4]!=""){
            draw_text(xx+1016,yy+728,sel_uni[4]);draw_rectangle(xx+1015,yy+727,xx+1016+string_width(sel_uni[4]),yy+727+string_height(sel_uni[4]),1);
            if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
                if (mouse_x>=xx+1016) and (mouse_y>=yy+727) and (mouse_x<xx+1016+string_width(sel_uni[4])) and (mouse_y<yy+727+string_height(sel_uni[4])){cooldown=8;sel_all=sel_uni[4];}
            }
        }
        
        if (sel_uni[5]!=""){
            draw_text(xx+1160,yy+662,sel_uni[5]);draw_rectangle(xx+1015+144,yy+661,xx+1160+string_width(sel_uni[5]),yy+661+string_height(sel_uni[5]),1);
            if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
                if (mouse_x>=xx+1160) and (mouse_y>=yy+661) and (mouse_x<xx+1160+string_width(sel_uni[5])) and (mouse_y<yy+661+string_height(sel_uni[5])){cooldown=8;sel_all=sel_uni[5];}
            }
        }
        if (sel_uni[6]!=""){
            draw_text(xx+1160,yy+684,sel_uni[6]);draw_rectangle(xx+1015+144,yy+683,xx+1160+string_width(sel_uni[6]),yy+683+string_height(sel_uni[6]),1);
            if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
                if (mouse_x>=xx+1160) and (mouse_y>=yy+684) and (mouse_x<xx+1160+string_width(sel_uni[6])) and (mouse_y<yy+684+string_height(sel_uni[6])){cooldown=8;sel_all=sel_uni[6];}
            }
        }
        if (sel_uni[7]!=""){
            draw_text(xx+1160,yy+706,sel_uni[7]);draw_rectangle(xx+1015+144,yy+705,xx+1160+string_width(sel_uni[7]),yy+705+string_height(sel_uni[7]),1);
            if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
                if (mouse_x>=xx+1160) and (mouse_y>=yy+706) and (mouse_x<xx+1160+string_width(sel_uni[7])) and (mouse_y<yy+706+string_height(sel_uni[7])){cooldown=8;sel_all=sel_uni[7];}
            }
        }
        if (sel_uni[8]!=""){
            draw_text(xx+1160,yy+728,sel_uni[8]);draw_rectangle(xx+1015+144,yy+727,xx+1160+string_width(sel_uni[8]),yy+727+string_height(sel_uni[8]),1);
            if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
                if (mouse_x>=xx+1160) and (mouse_y>=yy+728) and (mouse_x<xx+1160+string_width(sel_uni[8])) and (mouse_y<yy+727+string_height(sel_uni[8])){cooldown=8;sel_all=sel_uni[8];}
            }
        }
    }
    
    if (sel_veh[1]!=""){
        draw_text(xx+1010+288,yy+636,"All Vehicles");
        draw_rectangle(xx+1010+288,yy+634,xx+1010+288+string_width("All Vehicles"),yy+634+string_height("All Vehicles"),1);
        if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
            if (mouse_x>=xx+1010+288) and (mouse_y>=yy+634) and (mouse_x<xx+1010+288+string_width("All Vehicles")) and (mouse_y<yy+634+string_height("All Vehicles")){cooldown=8;sel_all="vehicle";}
        }
        
        if (sel_veh[1]!=""){
            draw_text(xx+1016+288,yy+662,sel_veh[1]);draw_rectangle(xx+1015+288,yy+661,xx+1016+288+string_width(sel_veh[1]),yy+661+string_height(sel_veh[1]),1);
            if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
                if (mouse_x>=xx+1015+288) and (mouse_y>=yy+661) and (mouse_x<xx+1016+288+string_width(sel_veh[1])) and (mouse_y<yy+661+string_height(sel_veh[1])){cooldown=8;sel_all=sel_veh[1];}
            }
        }
        if (sel_veh[2]!=""){
            draw_text(xx+1016+288,yy+684,sel_veh[2]);draw_rectangle(xx+1015+288,yy+683,xx+1016+288+string_width(sel_veh[2]),yy+683+string_height(sel_veh[2]),1);
            if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
                if (mouse_x>=xx+1015+288) and (mouse_y>=yy+683) and (mouse_x<xx+1016+288+string_width(sel_veh[2])) and (mouse_y<yy+683+string_height(sel_veh[2])){cooldown=8;sel_all=sel_veh[2];}
            }
        }
        if (sel_veh[3]!=""){
            draw_text(xx+1016+288,yy+706,sel_veh[3]);draw_rectangle(xx+1015+288,yy+705,xx+1016+288+string_width(sel_veh[3]),yy+705+string_height(sel_veh[3]),1);
            if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
                if (mouse_x>=xx+1015+288) and (mouse_y>=yy+705) and (mouse_x<xx+1016+288+string_width(sel_veh[3])) and (mouse_y<yy+705+string_height(sel_veh[3])){cooldown=8;sel_all=sel_veh[3];}
            }
        }
        if (sel_veh[4]!=""){
            draw_text(xx+1016+288,yy+728,sel_veh[4]);draw_rectangle(xx+1015+288,yy+727,xx+1016+288+string_width(sel_veh[4]),yy+727+string_height(sel_veh[4]),1);
            if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
                if (mouse_x>=xx+1015+288) and (mouse_y>=yy+728) and (mouse_x<xx+1016+288+string_width(sel_veh[4])) and (mouse_y<yy+727+string_height(sel_veh[4])){cooldown=8;sel_all=sel_veh[4];}
            }
        }
        
        if (sel_veh[5]!=""){
            draw_text(xx+1160+432,yy+662,sel_veh[5]);draw_rectangle(xx+1015+432,yy+661,xx+1160+432+string_width(sel_veh[5]),yy+661+string_height(sel_veh[5]),1);
            if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
                if (mouse_x>=xx+1160+432) and (mouse_y>=yy+661) and (mouse_x<xx+1160+432+string_width(sel_veh[5])) and (mouse_y<yy+661+string_height(sel_veh[5])){cooldown=8;sel_all=sel_veh[5];}
            }
        }
        if (sel_veh[6]!=""){
            draw_text(xx+1160+432,yy+684,sel_veh[6]);draw_rectangle(xx+1015+432,yy+683,xx+1160+432+string_width(sel_veh[6]),yy+683+string_height(sel_veh[6]),1);
            if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
                if (mouse_x>=xx+1160+432) and (mouse_y>=yy+683) and (mouse_x<xx+1160+432+string_width(sel_veh[6])) and (mouse_y<yy+683+string_height(sel_veh[6])){cooldown=8;sel_all=sel_veh[6];}
            }
        }
        if (sel_veh[7]!=""){
            draw_text(xx+1160+432,yy+706,sel_veh[7]);draw_rectangle(xx+1015+432,yy+705,xx+1160+432+string_width(sel_veh[7]),yy+705+string_height(sel_veh[7]),1);
            if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
                if (mouse_x>=xx+1160+432) and (mouse_y>=yy+706) and (mouse_x<xx+1160+432+string_width(sel_veh[7])) and (mouse_y<yy+705+string_height(sel_veh[7])){cooldown=8;sel_all=sel_veh[7];}
            }
        }
        if (sel_veh[8]!=""){
            draw_text(xx+1160+432,yy+728,sel_veh[8]);draw_rectangle(xx+1015+432,yy+727,xx+1160+432+string_width(sel_veh[8]),yy+727+string_height(sel_veh[8]),1);
            if (mouse_check_button_pressed(mb_left)) and (cooldown<=0){
                if (mouse_x>=xx+1160+432) and (mouse_y>=yy+728) and (mouse_x<xx+1160+432+string_width(sel_veh[8])) and (mouse_y<yy+727+string_height(sel_veh[8])){cooldown=8;sel_all=sel_veh[8];}
            }
        }
    }
    ...
    draw_set_halign(fa_left);
    draw_set_color(c_gray);
    draw_text_transformed(xx+1285,yy+610,"Select All",1.5,1.5,0);
    ...
    draw_set_alpha(1);
    if (sel_loading=0) then draw_text_transformed(xx+1089,yy+805,"Load",1.5,1.5,0);
    if (sel_loading!=0) then draw_text_transformed(xx+1089,yy+805,"Unload",1.5,1.5,0);
    ...
    draw_text_transformed(xx+1089+141,yy+805,"Re-equip",1.5,1.5,0);
    ...
    draw_text_transformed(xx+1089+282,yy+805,"Promote",1.5,1.5,0);
    
    x5=xx+1297+141;y5=yy+831;x6=xx+1436+141;y6=yy+805;
    draw_set_alpha(1);draw_rectangle(x5,y5,x6,y6,1);
    draw_set_alpha(0.5);draw_rectangle(x5+1,y5+1,x6-1,y6-1,1);
    draw_set_alpha(0.25);if (mouse_x>=x5) and (mouse_y>=y6) and (mouse_x<x6) and (mouse_y<y5) then draw_rectangle(x5,y5,x6,y6,0);
    draw_set_alpha(1);draw_text_transformed(xx+1089+423,yy+805,"Jail",1.5,1.5,0);
    ...
    draw_set_alpha(1);
    if (otha>0) then draw_set_alpha(0.5);
    draw_text_transformed(xx+1089+141,yy+805-26,"Reset",1.5,1.5,0);
    
    x5=xx+1297;y5=yy+831-26;x6=xx+1436;y6=yy+805-26;
    draw_set_alpha(1);draw_rectangle(x5,y5,x6,y6,1);
    draw_set_alpha(0.5);draw_rectangle(x5+1,y5+1,x6-1,y6-1,1);
    draw_set_alpha(0.25);if (mouse_x>=x5) and (mouse_y>=y6) and (mouse_x<x6) and (mouse_y<y5) then draw_rectangle(x5,y5,x6,y6,0);
    draw_set_alpha(1);draw_text_transformed(xx+1089+282,yy+805-26,"Transfer",1.5,1.5,0);
    ...
    draw_set_alpha(0.5);draw_rectangle(x5+1,y5+1,x6-1,y6-1,1);
    draw_set_alpha(0.25);if (mouse_x>=x5) and (mouse_y>=y6) and (mouse_x<x6) and (mouse_y<y5) then draw_rectangle(x5,y5,x6,y6,0);
    draw_set_alpha(1);draw_text_transformed(xx+1089+423,yy+807-26,"Add Bionics",1,1,0);
    draw_set_color(c_gray);
    ...
    draw_text_transformed(xx+1084,yy+807-26,"Set Boarder",1,1,0);
...
if (menu=30) and (managing>0){// Load to ships
    ...
    if (obj_ini.company_title[managing]!=""){draw_set_font(fnt_fancy);
        draw_text(xx+800,yy+110,"''"+string(obj_ini.company_title[managing])+"''");
    }
    ...
    repeat(min(ship_max,ship_see)){
        ...
        draw_set_color(c_gray);draw_rectangle(xx+25,yy+64,xx+974,yy+85,1);
        draw_text_transformed(xx+27,yy+66,string(temp1),1,1,0);draw_text_transformed(xx+27.5,yy+66.5,string(temp1),1,1,0);
    ...
    draw_set_font(fnt_40k_14b);
    draw_text_transformed(xx+320,yy+402,"Click a Ship to Load Selection (Req. "+string(man_size)+" Space)",1,1,0);
