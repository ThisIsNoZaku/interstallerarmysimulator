...
if (string_count(string(obj_img.gyro_adj)+" Pistol",wee)>0){ui_weapon[rl]=spr_weapon_boltpis;
    ui_arm[rl]=true;ui_above[rl]=true;ui_spec[rl]=false;display_type="normal_ranged";
}
if (string_count(string(obj_img.gyro),wee)>0) and (string_count("Heavy",wee)=0) and (string_count("Integrated",wee)=0){ui_weapon[rl]=spr_weapon_bolter;
...
if (string_count("Heavy "+string(obj_img.gyro),wee)>0){ui_weapon[rl]=spr_weapon_hbolt;display_type="ranged_twohand";
    ui_arm[1]=false;ui_arm[2]=false;ui_above[rl]=true;ui_spec[rl]=true;ui_twoh[rl]=true;
}
if (string_count(string(obj_img.laser)+"cannon",wee)>0){ui_weapon[rl]=spr_weapon_lasca;display_type="ranged_twohand";
    ui_arm[1]=false;ui_arm[2]=false;ui_above[rl]=true;ui_spec[rl]=true;ui_twoh[rl]=true;
}
...
if (string_count(string(obj_img.blade)+"sword",wee)>0){ui_weapon[rl]=spr_weapon_chsword;
    ui_arm[rl]=false;ui_above[rl]=true;ui_spec[rl]=true;display_type="melee_onehand";
}
if (string_count("Power Sword",wee)>0){ui_weapon[rl]=spr_weapon_powswo;
    ui_arm[rl]=false;ui_above[rl]=true;ui_spec[rl]=true;display_type="melee_onehand";
}
    if (string_count(string(obj_img.faction[6])+" Power Sword",wee)>0){ui_weapon[rl]=spr_weapon_eldsword;
        ui_arm[rl]=false;ui_above[rl]=true;ui_spec[rl]=true;display_type="melee_onehand";
    }
...
if (string_count(string(obj_img.hammer),wee)>0){ui_weapon[rl]=spr_weapon_thhammer;
    ui_arm[rl]=false;ui_above[rl]=true;ui_spec[rl]=true;display_type="melee_onehand";
}
...
if (string_count("Heavy "+string(obj_img.gyro),wee)>0){ui_weapon[rl]=spr_weapon_hbolt;
...
if (string_count(string(obj_img.laser)+"cannon",wee)>0){ui_weapon[rl]=spr_weapon_lasca;
    ui_arm[1]=false;ui_arm[2]=false;
    ui_above[rl]=true;ui_spec[rl]=true;ui_twoh[rl]=true;
    if (argument1=1){ui_xmod[rl]=-3;ui_ymod[rl]=12;}if (argument1=2){ui_xmod[rl]=-13;ui_ymod[rl]=14;}
}
