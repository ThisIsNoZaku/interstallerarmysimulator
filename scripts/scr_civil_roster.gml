    ...
    if (stop=0){
        ...
        if (okay>=1){
            ...
            if (obj_ncombat.battle_special="cs_meeting_battle7"){
                if (obj_ini.role[cooh,va]!=obj_img.faction_title[1]) then obj_ncombat.fighting[cooh,va]=-5;
            }
            
            if (obj_ini.role[cooh,va]=obj_img.faction_title[1]) then obj_ncombat.fighting[cooh,va]=1;
            ...
            if (he_good=-1){
                ...
                if (obj_ini.role[cooh,va]=obj_ini.role[100,15]) or (obj_ini.role[cooh,va]=obj_ini.role[100,14]) or (string_count("Aspirant",obj_ini.role[cooh,va])>0){
                    ...
                    if (obj_ini.armor[cooh,va]=string(obj_img.battlesuit)) then col=22-obj_controller.bat_terminator_column;
                    if (obj_ini.armor[cooh,va]="Tartaros Armor") then col=22-obj_controller.bat_terminator_column;
                    if (co=10) then col=22-obj_controller.bat_scout_column;
                }
                ...
                if (obj_ini.role[cooh,va]="Death Company"){// Ahahahahah
                    ...
                    if (string_count(obj_img.unit[1,6],obj_ini.armor[co,v])>0) then really=true;
                ...
                if (obj_ini.armor[co,v]="Scout Armor") then targ.dudes_ac[targ.men]=8;
                if (obj_ini.armor[co,v]="MK3 Iron Armor"){targ.dudes_ac[targ.men]=20;targ.dudes_ranged[targ.men]-=0.1;}
                if (obj_ini.armor[co,v]="MK4 Maximus"){targ.dudes_ac[targ.men]=19;targ.dudes_ranged[targ.men]+=0.05;targ.dudes_attack[targ.men]+=0.05;}
                if (obj_ini.armor[co,v]="MK6 Corvus"){targ.dudes_ac[targ.men]=18;targ.dudes_ranged[targ.men]+=0.1;}
                if (obj_ini.armor[co,v]="MK7 Aquila") then targ.dudes_ac[targ.men]=18;
                if (obj_ini.armor[co,v]="MK8 Errant") then targ.dudes_ac[targ.men]=19;
                if (obj_ini.armor[co,v]="Power Armor") then targ.dudes_ac[targ.men]=19;
                if (obj_ini.armor[co,v]="Artificer Armor"){targ.dudes_ac[targ.men]=35;targ.dudes_attack[targ.men]+=0.1;}
                if (obj_ini.armor[co,v]=string(obj_img.battlesuit)){targ.dudes_ac[targ.men]=40;targ.dudes_ranged[targ.men]-=0.1;targ.dudes_attack[targ.men]+=0.2;}
                if (obj_ini.armor[co,v]="Tartaros"){targ.dudes_ac[targ.men]=44;targ.dudes_ranged[targ.men]-=0.05;targ.dudes_attack[targ.men]+=0.2;}
                if (obj_ini.armor[co,v]=obj_img.unit[1,6]) then targ.dudes_ac[targ.men]=40;
                if (obj_ini.armor[co,v]="Ork Armor") then targ.dudes_ac[targ.men]=15;
                ...
                if (string_count("&",obj_ini.armor[co,v])>0){
                    // Artifact armor
                    if (string_count("Power",obj_ini.armor[co,v])>0) then targ.dudes_ac[targ.men]=30;
                    if (string_count("Artificer",obj_ini.armor[co,v])>0){targ.dudes_ac[targ.men]=37;targ.dudes_attack[targ.men]+=0.1;}
                    if (string_count(obj_img.battlesuit,obj_ini.armor[co,v])>0){targ.dudes_ac[targ.men]=46;targ.dudes_ranged[targ.men]-=0.1;targ.dudes_attack[targ.men]+=0.2;}
                    if (string_count(obj_img.unit[1,6],obj_ini.armor[co,v])>0) then targ.dudes_ac[targ.men]=44;
                }
                if (obj_ini.armor[co,v]!=""){// STC Bonuses
            ...
            if (he_good=1){sofar+=1;
                ...
                if (obj_ini.role[cooh,va]=obj_ini.role[100,15]) or (obj_ini.role[cooh,va]=obj_ini.role[100,14]) or (string_count("Aspirant",obj_ini.role[cooh,va])>0){
                    ...
                    if (obj_ini.armor[cooh,va]=string(obj_img.battlesuit)) then col=obj_controller.bat_terminator_column;
                ...
                if (obj_ini.role[cooh,va]=obj_img.faction_title[1]){
                ...
                if (obj_ini.role[cooh,va]="Death Company"){// Ahahahahah
                    var really;really=false;
                    if (string_count(string(obj_img.unit[1,6]),targ.marine_armor[targ.men])>0) then really=true;
                ...
                if (targ.marine_armor[targ.men]=string(obj_img.battlesuit)){targ.marine_ac[targ.men]=40;targ.marine_ranged[targ.men]-=0.1;targ.marine_attack[targ.men]+=0.2;}
                ...
                if (targ.marine_armor[targ.men]=obj_img.unit[1,6]) then targ.marine_ac[targ.men]=40;
                ...
                if (string_count("&",targ.marine_armor[targ.men])>0){
                    ...
                    if (string_count(string(obj_img.battlesuit),targ.marine_armor[targ.men])>0){targ.marine_ac[targ.men]=46;targ.marine_ranged[targ.men]-=0.1;targ.marine_attack[targ.men]+=0.2;}
