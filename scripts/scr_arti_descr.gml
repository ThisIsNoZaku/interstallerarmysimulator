...
if (obj_ini.artifact[argument0]=string(obj_img.battlesuit)) then typ="armor";
if (obj_ini.artifact[argument0]=obj_img.unit[1,6]) then typ="armor";
...
if (obj_ini.artifact[argument0]!="Power Armor") and (obj_ini.artifact[argument0]!=string(obj_img.battlesuit)) and (obj_ini.artifact[argument0]!="Artificer Armor"){
...
if (obj_ini.artifact[argument0]="Power Armor") or (obj_ini.artifact[argument0]=string(obj_img.battlesuit)) or (obj_ini.artifact[argument0]="Artificer Armor"){
    p1="This artifact is "+string(obj_ini.artifact[argument0]);
    if (string_count("inq",temp)>0) then p1+=", entrusted by the Inquisition.";
    if (string_count("inq",temp)=0) then p1+=".";
}
if (string_count("|cgf",temp)>0) then p1="This artifact is a "+string(obj_ini.artifact[argument0])+" gifted by the "+string(obj_img.faction_title[11])+".";
