...
if (argument1<=-666) or (argument1=666){with(obj_img){// Clear out these images
    ...
    if (argument0="resource") or (argument0="all") or (argument0="") then resource_good=false;
    ...
    repeat(80){i+=1;
        ...
        if ((argument0="resource") or (argument0="all") or (argument0="")){
            if (resource_exists[i]>0) and (sprite_exists(resource[i])){sprite_delete(resource[i]);resource_exists[i]=-1;resource[i]=0;}
        }
    }
...
if (argument1>-600) and (argument1<0){with(obj_img){// Initialize these images
    ...
    repeat(80){i+=1;
        ...
        if (argument0="resource") and (resource_exists[i]>0) and (sprite_exists(resource[i])){
            sprite_delete(resource[i]);resource_exists[i]=-1;resource[i]=0;
        }
    ...
    if (argument0="resource"){resource_good=false;single_image=true;}
    ...
    if (single_image=true){
        ...
        if (argument0="resource") and (file_exists(working_directory + "\images\ui\resources.png")){
            resource[1]=sprite_add(working_directory + "\images\ui\resources.png",4,false,false,0,0);resource_exists[1]=true;resource_good=true;
        }
    }
...
if (argument0!="") and (argument1>=0) and (argument1!=666){with(obj_img){// Draw the image
    ...
    if (argument0="resource"){
        if (resource_exists[1]>0) and (sprite_exists(resource[1])){drawing_sprite=resource[1];drawing_exists=true;}
    }
