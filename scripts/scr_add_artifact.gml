...
if (t1="Weapon") and (t2=""){good=0;
    if (rand2<=30) and (good=0){t2=string(obj_img.gyro);good=1;}
...
if (t1="Armor") and (t2=""){good=0;
    ...
    if (rand2<=80) and (good=0){t2=string(obj_img.battlesuit);good=1;}
...
if (argument0="good"){
    ...
    if (haha=4){t1="Armor";t2=string(obj_img.battlesuit);}
}
