...
if (argument0=2) or (argument0=0){debugl("Loading slot "+string(argument1)+" part 2");
    ...
    var i;i=-1;
    repeat(stars){i+=1;
        var new;new=instance_create(0,0,obj_star);
        
        new.name=ini_read_string("Star","sr"+string(i)+"name","");
        new.star=ini_read_string("Star","sr"+string(i)+"star","");
        new.planets=ini_read_real("Star","sr"+string(i)+"planets",0);
        new.owner=ini_read_real("Star","sr"+string(i)+"owner",0);
        new.x=ini_read_real("Star","sr"+string(i)+"x",0);
        new.y=ini_read_real("Star","sr"+string(i)+"y",0);
        new.x2=ini_read_real("Star","sr"+string(i)+"x2",0);
        new.y2=ini_read_real("Star","sr"+string(i)+"y2",0);
        new.old_x=ini_read_real("Star","sr"+string(i)+"ox",0);
        new.old_y=ini_read_real("Star","sr"+string(i)+"oy",0);
        
        new.vision=ini_read_real("Star","sr"+string(i)+"vision",1);
        new.storm=ini_read_real("Star","sr"+string(i)+"storm",0);
        new.trader=ini_read_real("Star","sr"+string(i)+"trader",0);
        new.craftworld=ini_read_real("Star","sr"+string(i)+"craftworld",0);
        new.space_hulk=ini_read_real("Star","sr"+string(i)+"spacehulk",0);
        if (new.space_hulk=1) then new.sprite_index=spr_star_hulk;
        
        var g;g=0;
        repeat(4){g+=1;
            if (new.planets>=g){
                new.planet[g]=ini_read_real("Star","sr"+string(i)+"plan"+string(g),0);
                new.dispo[g]=ini_read_real("Star","sr"+string(i)+"dispo"+string(g),-10);
                new.p_type[g]=ini_read_string("Star","sr"+string(i)+"type"+string(g),"");
                new.p_feature[g]=ini_read_string("Star","sr"+string(i)+"feat"+string(g),"");
                new.p_owner[g]=ini_read_real("Star","sr"+string(i)+"own"+string(g),0);
                new.p_first[g]=ini_read_real("Star","sr"+string(i)+"fir"+string(g),0);
                new.p_population[g]=ini_read_real("Star","sr"+string(i)+"popul"+string(g),0);
                new.p_max_population[g]=ini_read_real("Star","sr"+string(i)+"maxpop"+string(g),0);
                new.p_large[g]=ini_read_real("Star","sr"+string(i)+"large"+string(g),0);
                new.p_pop[g]=ini_read_string("Star","sr"+string(i)+"pop"+string(g),"");
                new.p_guardsmen[g]=ini_read_real("Star","sr"+string(i)+"guard"+string(g),0);
                new.p_pdf[g]=ini_read_real("Star","sr"+string(i)+"pdf"+string(g),0);
                new.p_fortified[g]=ini_read_real("Star","sr"+string(i)+"forti"+string(g),0);
                new.p_station[g]=ini_read_real("Star","sr"+string(i)+"stat"+string(g),0);
                
                new.p_player[g]=ini_read_real("Star","sr"+string(i)+"play"+string(g),0);
                new.p_lasers[g]=ini_read_real("Star","sr"+string(i)+"p_lasers"+string(g),0);
                new.p_silo[g]=ini_read_real("Star","sr"+string(i)+"p_silo"+string(g),0);
                new.p_defenses[g]=ini_read_real("Star","sr"+string(i)+"p_defenses"+string(g),0);
                new.p_upgrades[g]=ini_read_string("Star","sr"+string(i)+"upg"+string(g),"");
                
                new.p_orks[g]=ini_read_real("Star","sr"+string(i)+"or"+string(g),0);
                new.p_tau[g]=ini_read_real("Star","sr"+string(i)+"ta"+string(g),0);
                new.p_eldar[g]=ini_read_real("Star","sr"+string(i)+"el"+string(g),0);
                new.p_traitors[g]=ini_read_real("Star","sr"+string(i)+"tr"+string(g),0);
                new.p_chaos[g]=ini_read_real("Star","sr"+string(i)+"ch"+string(g),0);
                new.p_demons[g]=ini_read_real("Star","sr"+string(i)+"de"+string(g),0);
                new.p_sisters[g]=ini_read_real("Star","sr"+string(i)+"si"+string(g),0);
                new.p_necrons[g]=ini_read_real("Star","sr"+string(i)+"ne"+string(g),0);
                new.p_tyranids[g]=ini_read_real("Star","sr"+string(i)+"tyr"+string(g),0);
                    new.p_halp[g]=ini_read_real("Star","sr"+string(i)+"halp"+string(g),0);
                
                new.p_heresy[g]=ini_read_real("Star","sr"+string(i)+"heresy"+string(g),0);
                new.p_hurssy[g]=ini_read_real("Star","sr"+string(i)+"hurssy"+string(g),0);
                new.p_hurssy_time[g]=ini_read_real("Star","sr"+string(i)+"hurssy_time"+string(g),0);
                new.p_heresy_secret[g]=ini_read_real("Star","sr"+string(i)+"heresy_secret"+string(g),0);
                new.p_influence[g]=ini_read_real("Star","sr"+string(i)+"influence"+string(g),0);
                new.p_raided[g]=ini_read_real("Star","sr"+string(i)+"raided"+string(g),0);
                ...
                */
                ...
                new.p_problem[g,1]=ini_read_string("Star","sr"+string(i)+"prob"+string(g)+".1","");
                new.p_timer[g,1]=ini_read_real("Star","sr"+string(i)+"time"+string(g)+".1",0);
                new.p_problem[g,2]=ini_read_string("Star","sr"+string(i)+"prob"+string(g)+".2","");
                new.p_timer[g,2]=ini_read_real("Star","sr"+string(i)+"time"+string(g)+".2",0);
                new.p_problem[g,3]=ini_read_string("Star","sr"+string(i)+"prob"+string(g)+".3","");
                new.p_timer[g,3]=ini_read_real("Star","sr"+string(i)+"time"+string(g)+".3",0);
                new.p_problem[g,4]=ini_read_string("Star","sr"+string(i)+"prob"+string(g)+".4","");
                new.p_timer[g,4]=ini_read_real("Star","sr"+string(i)+"time"+string(g)+".4",0);
            }
        }
    }
        ...
        repeat(6600){
            if (good=0){
                ...
                if (good=0){
                    ...
                    if (coh=0){
                        if (obj_ini.role[coh,mah]=obj_img.faction_title[1]) then obj_ini.race[coh,mah]=1;
