...
if (thinz!=0){
    ...
    if (argument0=string(obj_img.battlesuit)){get_integer2("Terminator Armor wanted?",5,"t"+string(thinz),string(obj_img.battlesuit));}
    ...
    if (argument0=string(obj_img.faction[6])+" Power Sword"){get_integer2(string(obj_img.faction[6])+" Power Swords wanted?",5,"t"+string(thinz),string(obj_img.faction[6])+" Power Sword");}
    ...
    if (argument0=obj_img.unit[5,7]){get_integer2(string(obj_img.unit[5,7])+" wanted?",3,"t"+string(thinz),obj_img.unit[5,7]);}
    if (argument0=obj_img.unit[5,17]){trade_tnum[thinz]=1;tomp1=1;}
