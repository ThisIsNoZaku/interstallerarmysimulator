    ...
    repeat(500){ey+=1;
        if (obj_ini.role[com,ey]!=""){
            if (obj_ini.ship_size[shiyp]<3){
                var n_size;n_size=1;
                if (obj_ini.armor[com,ey]=string(obj_img.battlesuit)) then n_size+=1;
                if (obj_ini.armor[com,ey]="Tartaros") then n_size+=1;
                if (obj_ini.armor[com,ey]=obj_img.unit[1,6]) then n_size+=7;
                if (obj_ini.role[com,ey]=obj_img.faction_title[1]) then n_size+=1;
            ...
            company_size+=1;
            if (obj_ini.armor[com,ey]=string(obj_img.battlesuit)) then company_size+=1;
            if (obj_ini.armor[com,ey]="Tartaros") then company_size+=1;
            if (obj_ini.armor[com,ey]=obj_img.unit[1,6]) then company_size+=7;
            // if (obj_ini.mobi[com,ey]="Jump Pack") then company_size+=1;
            if (obj_ini.role[com,ey]=obj_img.faction_title[1]) then company_size+=1;
        }
    }
    remove_size+=company_size;
    obj_ini.ship_carrying[shiyp]+=company_size;
...
repeat(500){ey+=1;
    ...
    if (obj_ini.role[com,ey]!=""){
        ...
        if (obj_ini.armor[com,ey]=string(obj_img.battlesuit)){company_size+=1;mah_size+=1;}
        if (obj_ini.armor[com,ey]="Tartaros"){company_size+=1;mah_size+=1;}
        if (obj_ini.armor[com,ey]=obj_img.unit[1,6]){company_size+=7;mah_size+=7;}
...
if (splinter=1){
    ...
    repeat(obj_ini.strike_cruisers){
        ...
        var new;new=instance_create(flit.x-8,flit.y,obj_star_event);new.col="green";
