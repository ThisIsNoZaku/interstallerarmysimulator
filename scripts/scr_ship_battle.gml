            ...
            if (stop=0){
                ...
                if (okay=1){
                    ...
                    if (obj_ini.role[co,v]=obj_ini.role[100,15]) or (obj_ini.role[co,v]=obj_ini.role[100,14]){
                        ...
                        if (obj_ini.armor[co,v]=string(obj_img.battlesuit)) then col=obj_controller.bat_terminator_column;
                    ...
                    if (obj_ini.role[co,v]=obj_ini.role[100,5]) or (obj_ini.role[co,v]="Standard Bearer"){
                    ...
                    if (obj_ini.role[co,v]=obj_img.faction_title[1]){col=obj_controller.bat_command_column;obj_ncombat.important_dudes+=1;obj_ncombat.big_mofo=1;}
                    ...
                    if (targ.marine_armor[targ.men]=string(obj_img.battlesuit)) or (targ.marine_armor[targ.men]=obj_img.unit[1,6]) then targ.marine_ac[targ.men]=40;
                    ...
                    if (string_count("&",targ.marine_armor[targ.men])>0) or (string_count("|",targ.marine_armor[targ.men])>0){
                        ...
                        if (string_count(string(obj_img.battlesuit),targ.marine_armor[targ.men])>0) then targ.marine_ac[targ.men]=42;
