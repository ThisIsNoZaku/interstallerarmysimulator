        ...
        repeat(300){v+=1;
            ...
            if (stop=0){
                ...
                if (string_count("spyrer",obj_ncombat.battle_special)>0) or (obj_ncombat.battle_special="space_hulk") or (string_count("chaos_meeting",obj_ncombat.battle_special)>0){
                    if (string_count(obj_img.unit[1,6],obj_ini.armor[co,v])>0) then okay=-1;
                }
                ...
                if (v<=100) and (string_count("spyrer",obj_ncombat.battle_special)=0) and (co<=10) and (meat=false){
                    ...
                    if (vokay>=1) and (obj_ncombat.dropping=0){
                        ...
                        if (obj_ini.veh_role[co,v]=string(obj_img.unit[1,18])){col=obj_controller.bat_rhino_column;obj_ncombat.rhinos+=1;}
                        if (obj_ini.veh_role[co,v]=string(obj_img.unit[1,19])){col=obj_controller.bat_predator_column;obj_ncombat.predators+=1;}
                        if (obj_ini.veh_role[co,v]=string(obj_img.unit[1,21])){col=obj_controller.bat_landraider_column;obj_ncombat.land_raiders+=1;}
                        if (obj_ini.veh_role[co,v]=string(obj_img.unit[1,20])){col=1;obj_ncombat.whirlwinds+=1;}
                        ...
                        if (obj_ini.veh_role[co,v]=string(obj_img.unit[1,18])) or (obj_ini.veh_role[co,v]=string(obj_img.unit[1,20])) or (obj_ini.veh_role[co,v]=string(obj_img.unit[1,22])){
                            targ.veh_hp[targ.veh]=obj_ini.veh_hp[co,v]*2;
                            targ.veh_hp_multiplier[targ.veh]=2;
                            targ.veh_ac[targ.veh]=20;
                        }
                        if (obj_ini.veh_role[co,v]=string(obj_img.unit[1,19])){
                            targ.veh_hp[targ.veh]=obj_ini.veh_hp[co,v]*3;
                            targ.veh_hp_multiplier[targ.veh]=3;
                            targ.veh_ac[targ.veh]=30;
                        }
                        if (obj_ini.veh_role[co,v]=string(obj_img.unit[1,21])){
